      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'submissions' }, (payload) => {
        ...
        if (payload.eventType === 'INSERT') {
            setQuestProgress(prev => {
                ...
                // 2. Check if we have a TEMP/OPTIMISTIC version for this specific quest
                // This finds the "Ghost" row generated by the Accept button
                const existingOptimistic = prev.find(p => 
                ...
                if (existingOptimistic) {
                    ...
                    return prev.map(p => p.id === existingOptimistic.id ? payload.new : p);
                }
